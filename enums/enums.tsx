...
export enum AppIcon {
    ...
    Question = require('../assets/images/app-icons/question.png'),
}
...
export const AvatarIconArray = [
    ...
    AvatarIcon.Scripture,
    AvatarIcon.Sleep,
    AvatarIcon.Sheep,
    AvatarIcon.PlantSeeds,
    AvatarIcon.PlantSun,
    AvatarIcon.PlantWater,
    AvatarIcon.PlantMature,
    AvatarIcon.MosaicOrange,
    AvatarIcon.Leadership,
    AvatarIcon.LightBulb,
    AvatarIcon.Health,
    AvatarIcon.Exodus,
    AvatarIcon.Elementary,
    AvatarIcon.Controller,
    AvatarIcon.Cross,
    AvatarIcon.Apple,
    AvatarIcon.BestFriend,
    AvatarIcon.Bird,
    AvatarIcon.Atheist,
    AvatarIcon.Backpack,
    AvatarIcon.Basketball
];