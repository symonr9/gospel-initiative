...
type ISettingsUserPrefs = ViewProps & {
    executor: User;
    refreshData: Function;
    setAppError: Function;
};

function SettingsUserPrefs({ executor, refreshData, setAppError }: ISettingsUserPrefs) {
    return (
        <View>
...
export default connect(mapStateToProps, mapDispatchToProps)(SettingsUserPrefs));