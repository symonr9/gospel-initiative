...
function HomeDailyTasksCard({ beaconActivities, activeBeacons, expiredBeacons, ones,
    ...
    const detailsView = (
        <PageColumn>
            <PageRow style={{ gap: 8 }}>
                <PageRow style={{ gap: 8, marginTop: 10 }}>
                ...
                <Image source={showDailyTasks ? AppIcon.ChevronUp : AppIcon.ChevronDown}
                    style={{ height: 30, width: 30, marginStart: 24 }} />
            </PageRow>
    ...
    let cardSubtitle = hasUnlockedSecondPractice
        ? `You have unlocked your second practice for today.`
    ...
    return (
        <SimpleCard iconSrc={AppIcon.Chart}
            ...
            onClick={() => setShowDailyTasks(val => !val)}
